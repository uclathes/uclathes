...
These instructions are {\em not\/} intended to replace
...
The \verb+thesis+ document style is basically the same
...
\begin {center} \verb+\bibliographystyle {thesis}+ \end {center}
...
{\em after\/} the \verb+\begin {document}+ command
