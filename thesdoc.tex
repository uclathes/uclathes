...
\begin {center}
\verb+\documentstyle [+{\sl options\/}\verb+] {uclathes}+
\end {center}
...
\begin {center}
\verb+\documentstyle [PhD,single] {uclathes}+ \\
{\em or} \\
\verb+\documentstyle [MS,single] {uclathes}+
\end {center}
...
{\slshape  Maintainer's note:  These were Rich Wales' future developments.
...
{\slshape  Maintainer's note:  I'm very interested
  in hearing about objections the \tdadvisor\ has to
  the default format provided by \verb|uclathes|.
   ---John.}

\end {document}
% LocalWords:  umi uclathes microfilming snooze documentstyle ms phd annote tex
% LocalWords:  bibliographystyle diss Connectionless Gerla San prelim Los Berne
% LocalWords:  MADHOUS signatory signatories co de
